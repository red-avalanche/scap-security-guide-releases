...
###############################################################################
# BEGIN fix (1 / 33) for 'etcd_wal_dir'
###############################################################################
(>&2 echo "Remediating rule 1/33: 'etcd_wal_dir'")
...
###############################################################################
# BEGIN fix (5 / 33) for 'etcd_cert_file'
###############################################################################
(>&2 echo "Remediating rule 5/33: 'etcd_cert_file'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (6 / 33) for 'etcd_auto_tls'
###############################################################################
(>&2 echo "Remediating rule 6/33: 'etcd_auto_tls'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (7 / 33) for 'etcd_key_file'
###############################################################################
(>&2 echo "Remediating rule 7/33: 'etcd_key_file'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (8 / 33) for 'etcd_peer_auto_tls'
###############################################################################
(>&2 echo "Remediating rule 8/33: 'etcd_peer_auto_tls'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (9 / 33) for 'etcd_unique_ca'
###############################################################################
(>&2 echo "Remediating rule 9/33: 'etcd_unique_ca'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (10 / 33) for 'etcd_peer_client_cert_auth'
###############################################################################
(>&2 echo "Remediating rule 10/33: 'etcd_peer_client_cert_auth'")
# Function to replace configuration setting in config file or add the configuration setting if
# it does not exist.
#
# Expects arguments:
...
###############################################################################
# BEGIN fix (12 / 33) for 'api_server_insecure_bind_address'
###############################################################################
(>&2 echo "Remediating rule 12/33: 'api_server_insecure_bind_address'")
(>&2 echo "FIX FOR THIS RULE 'api_server_insecure_bind_address' IS MISSING!")

# END fix for 'api_server_insecure_bind_address'

###############################################################################
# BEGIN fix (13 / 33) for 'api_server_basic_auth'
###############################################################################
(>&2 echo "Remediating rule 13/33: 'api_server_basic_auth'")
(>&2 echo "FIX FOR THIS RULE 'api_server_basic_auth' IS MISSING!")

# END fix for 'api_server_basic_auth'

###############################################################################
# BEGIN fix (14 / 33) for 'api_server_audit_log_maxage'
###############################################################################
(>&2 echo "Remediating rule 14/33: 'api_server_audit_log_maxage'")
(>&2 echo "FIX FOR THIS RULE 'api_server_audit_log_maxage' IS MISSING!")

# END fix for 'api_server_audit_log_maxage'

###############################################################################
# BEGIN fix (15 / 33) for 'api_server_etcd_cert'
###############################################################################
(>&2 echo "Remediating rule 15/33: 'api_server_etcd_cert'")
(>&2 echo "FIX FOR THIS RULE 'api_server_etcd_cert' IS MISSING!")

# END fix for 'api_server_etcd_cert'

###############################################################################
# BEGIN fix (16 / 33) for 'api_server_etcd_key'
###############################################################################
(>&2 echo "Remediating rule 16/33: 'api_server_etcd_key'")
(>&2 echo "FIX FOR THIS RULE 'api_server_etcd_key' IS MISSING!")

# END fix for 'api_server_etcd_key'

###############################################################################
# BEGIN fix (17 / 33) for 'api_server_kubelet_client_key'
###############################################################################
(>&2 echo "Remediating rule 17/33: 'api_server_kubelet_client_key'")
(>&2 echo "FIX FOR THIS RULE 'api_server_kubelet_client_key' IS MISSING!")

# END fix for 'api_server_kubelet_client_key'

###############################################################################
# BEGIN fix (18 / 33) for 'api_server_secure_port'
###############################################################################
(>&2 echo "Remediating rule 18/33: 'api_server_secure_port'")
(>&2 echo "FIX FOR THIS RULE 'api_server_secure_port' IS MISSING!")

# END fix for 'api_server_secure_port'

###############################################################################
# BEGIN fix (19 / 33) for 'api_server_audit_log_maxsize'
###############################################################################
(>&2 echo "Remediating rule 19/33: 'api_server_audit_log_maxsize'")
(>&2 echo "FIX FOR THIS RULE 'api_server_audit_log_maxsize' IS MISSING!")

# END fix for 'api_server_audit_log_maxsize'

###############################################################################
# BEGIN fix (20 / 33) for 'api_server_authorization_mode'
###############################################################################
(>&2 echo "Remediating rule 20/33: 'api_server_authorization_mode'")
(>&2 echo "FIX FOR THIS RULE 'api_server_authorization_mode' IS MISSING!")

# END fix for 'api_server_authorization_mode'

###############################################################################
# BEGIN fix (21 / 33) for 'api_server_etcd_ca'
###############################################################################
(>&2 echo "Remediating rule 21/33: 'api_server_etcd_ca'")
(>&2 echo "FIX FOR THIS RULE 'api_server_etcd_ca' IS MISSING!")

# END fix for 'api_server_etcd_ca'

###############################################################################
# BEGIN fix (22 / 33) for 'api_server_request_timeout'
###############################################################################
(>&2 echo "Remediating rule 22/33: 'api_server_request_timeout'")
(>&2 echo "FIX FOR THIS RULE 'api_server_request_timeout' IS MISSING!")

# END fix for 'api_server_request_timeout'

###############################################################################
# BEGIN fix (23 / 33) for 'api_server_kubelet_client_cert'
###############################################################################
(>&2 echo "Remediating rule 23/33: 'api_server_kubelet_client_cert'")
(>&2 echo "FIX FOR THIS RULE 'api_server_kubelet_client_cert' IS MISSING!")

# END fix for 'api_server_kubelet_client_cert'

###############################################################################
# BEGIN fix (24 / 33) for 'api_server_kubelet_certificate_authority'
###############################################################################
(>&2 echo "Remediating rule 24/33: 'api_server_kubelet_certificate_authority'")
...
###############################################################################
# BEGIN fix (25 / 33) for 'api_server_client_ca'
###############################################################################
(>&2 echo "Remediating rule 25/33: 'api_server_client_ca'")
(>&2 echo "FIX FOR THIS RULE 'api_server_client_ca' IS MISSING!")

# END fix for 'api_server_client_ca'

###############################################################################
# BEGIN fix (26 / 33) for 'api_server_anonymous_auth'
###############################################################################
(>&2 echo "Remediating rule 26/33: 'api_server_anonymous_auth'")
(>&2 echo "FIX FOR THIS RULE 'api_server_anonymous_auth' IS MISSING!")

# END fix for 'api_server_anonymous_auth'

###############################################################################
# BEGIN fix (27 / 33) for 'api_server_kubelet_https'
###############################################################################
(>&2 echo "Remediating rule 27/33: 'api_server_kubelet_https'")
(>&2 echo "FIX FOR THIS RULE 'api_server_kubelet_https' IS MISSING!")

# END fix for 'api_server_kubelet_https'

###############################################################################
# BEGIN fix (28 / 33) for 'api_server_tls_private_key'
###############################################################################
(>&2 echo "Remediating rule 28/33: 'api_server_tls_private_key'")
(>&2 echo "FIX FOR THIS RULE 'api_server_tls_private_key' IS MISSING!")

# END fix for 'api_server_tls_private_key'

###############################################################################
# BEGIN fix (29 / 33) for 'api_server_tls_cert'
###############################################################################
(>&2 echo "Remediating rule 29/33: 'api_server_tls_cert'")
...
###############################################################################
# BEGIN fix (31 / 33) for 'api_server_token_auth'
###############################################################################
(>&2 echo "Remediating rule 31/33: 'api_server_token_auth'")
(>&2 echo "FIX FOR THIS RULE 'api_server_token_auth' IS MISSING!")

# END fix for 'api_server_token_auth'

###############################################################################
# BEGIN fix (32 / 33) for 'api_server_audit_log_maxbackup'
###############################################################################
(>&2 echo "Remediating rule 32/33: 'api_server_audit_log_maxbackup'")
(>&2 echo "FIX FOR THIS RULE 'api_server_audit_log_maxbackup' IS MISSING!")

# END fix for 'api_server_audit_log_maxbackup'

###############################################################################
# BEGIN fix (33 / 33) for 'api_server_insecure_port'
###############################################################################
(>&2 echo "Remediating rule 33/33: 'api_server_insecure_port'")
