...
###############################################################################
# BEGIN fix (2 / 11) for 'java_jre_validation_crl'
###############################################################################
(>&2 echo "Remediating rule 2/11: 'java_jre_validation_crl'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (3 / 11) for 'java_jre_validation_crl_locked'
###############################################################################
(>&2 echo "Remediating rule 3/11: 'java_jre_validation_crl_locked'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (4 / 11) for 'java_jre_validation_ocsp'
###############################################################################
(>&2 echo "Remediating rule 4/11: 'java_jre_validation_ocsp'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
