...
###############################################################################
# BEGIN fix (1 / 11) for 'java_jre_untrusted_sources'
###############################################################################
(>&2 echo "Remediating rule 1/11: 'java_jre_untrusted_sources'")
...
###############################################################################
# BEGIN fix (3 / 11) for 'java_jre_validation_ocsp_locked'
###############################################################################
(>&2 echo "Remediating rule 3/11: 'java_jre_validation_ocsp_locked'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (4 / 11) for 'java_jre_validation_crl'
###############################################################################
(>&2 echo "Remediating rule 4/11: 'java_jre_validation_crl'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (5 / 11) for 'java_jre_validation_ocsp'
###############################################################################
(>&2 echo "Remediating rule 5/11: 'java_jre_validation_ocsp'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (6 / 11) for 'java_jre_updated'
###############################################################################
(>&2 echo "Remediating rule 6/11: 'java_jre_updated'")
(>&2 echo "FIX FOR THIS RULE 'java_jre_updated' IS MISSING!")

# END fix for 'java_jre_updated'

###############################################################################
# BEGIN fix (7 / 11) for 'java_jre_deployment_properties_exists'
###############################################################################
(>&2 echo "Remediating rule 7/11: 'java_jre_deployment_properties_exists'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (8 / 11) for 'java_jre_untrusted_sources_locked'
###############################################################################
(>&2 echo "Remediating rule 8/11: 'java_jre_untrusted_sources_locked'")
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
...
###############################################################################
# BEGIN fix (9 / 11) for 'java_jre_deployment_config_exists'
###############################################################################
(>&2 echo "Remediating rule 9/11: 'java_jre_deployment_config_exists'")
...
###############################################################################
# BEGIN fix (11 / 11) for 'java_jre_deployment_config_properties'
###############################################################################
(>&2 echo "Remediating rule 11/11: 'java_jre_deployment_config_properties'")
JAVA_CONFIG="/etc/.java/deployment/deployment.config"
JAVA_PROPERTIES="/etc/.java/deployment/deployment.properties"
