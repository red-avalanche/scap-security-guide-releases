...
###############################################################################
#
# Bash Remediation Script for CIS AlmaLinux OS 9 Benchmark for Level 1 - Workstation
#
# Profile Description:
...
# $ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_cis_workstation_l1 --fix-type bash ssg-almalinux9-ds.xml
#
...
var_multiple_time_servers='0.almalinux.pool.ntp.org,1.almalinux.pool.ntp.org,2.almalinux.pool.ntp.org,3.almalinux.pool.ntp.org'
...
find -L /etc/ssh/ -maxdepth 1 -type f  ! -group 0 -regextype posix-extended -regex '^.*_key$' -exec chgrp -L $newgroup {} \;
