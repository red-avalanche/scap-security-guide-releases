...
###############################################################################
#
# Bash Remediation Script for Centro Criptológico Nacional (CCN) - STIC for Oracle Linux 9 - Advanced
#
# Profile Description:
...
# $ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_ccn_advanced --fix-type bash ssg-ol9-ds.xml
#
