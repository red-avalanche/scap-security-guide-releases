...
###############################################################################
#
# Bash Remediation Script for Australian Cyber Security Centre (ACSC) ISM Official - Base
#
# Profile Description:
...
# $ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_ism_o --fix-type bash ssg-cs10-ds.xml
#
