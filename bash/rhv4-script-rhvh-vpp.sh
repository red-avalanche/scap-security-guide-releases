...
# $ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_rhvh-vpp --fix-type bash xccdf-file.xml
#
...
(>&2 echo "FIX FOR THIS RULE 'xccdf_org.ssgproject.content_rule_no_password_auth_for_systemaccounts' IS MISSING!")
