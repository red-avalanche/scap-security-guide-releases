...
###############################################################################
# BEGIN fix (5 / 67) for 'jboss_activemq-pki_web_console'
###############################################################################
(>&2 echo "Remediating rule 5/67: 'jboss_activemq-pki_web_console'")
...
###############################################################################
# BEGIN fix (9 / 67) for 'jboss_activemq-java_aaa_service'
###############################################################################
(>&2 echo "Remediating rule 9/67: 'jboss_activemq-java_aaa_service'")
...
###############################################################################
# BEGIN fix (11 / 67) for 'jboss_karaf-java_vendor_supported'
###############################################################################
(>&2 echo "Remediating rule 11/67: 'jboss_karaf-java_vendor_supported'")
...
###############################################################################
# BEGIN fix (14 / 67) for 'jboss_karaf-deployed_java_network_permissions'
###############################################################################
(>&2 echo "Remediating rule 14/67: 'jboss_karaf-deployed_java_network_permissions'")
...
###############################################################################
# BEGIN fix (15 / 67) for 'jboss_karaf-java_aaa_service'
###############################################################################
(>&2 echo "Remediating rule 15/67: 'jboss_karaf-java_aaa_service'")
...
###############################################################################
# BEGIN fix (17 / 67) for 'jboss_karaf-dod_hardware_pki_token'
###############################################################################
(>&2 echo "Remediating rule 17/67: 'jboss_karaf-dod_hardware_pki_token'")
...
###############################################################################
# BEGIN fix (19 / 67) for 'jboss_karaf-reduce_logging'
###############################################################################
(>&2 echo "Remediating rule 19/67: 'jboss_karaf-reduce_logging'")
...
###############################################################################
# BEGIN fix (21 / 67) for 'jboss_karaf-ldap_securely_fail'
###############################################################################
(>&2 echo "Remediating rule 21/67: 'jboss_karaf-ldap_securely_fail'")
...
###############################################################################
# BEGIN fix (23 / 67) for 'jboss_karaf-config_file_permissions'
###############################################################################
(>&2 echo "Remediating rule 23/67: 'jboss_karaf-config_file_permissions'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-config_file_permissions' IS MISSING!")

# END fix for 'jboss_karaf-config_file_permissions'

###############################################################################
# BEGIN fix (24 / 67) for 'jboss_karaf-deployed_permissions'
###############################################################################
(>&2 echo "Remediating rule 24/67: 'jboss_karaf-deployed_permissions'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-deployed_permissions' IS MISSING!")

# END fix for 'jboss_karaf-deployed_permissions'

###############################################################################
# BEGIN fix (25 / 67) for 'jboss_karaf-deployed_runtime_permissions'
###############################################################################
(>&2 echo "Remediating rule 25/67: 'jboss_karaf-deployed_runtime_permissions'")
...
###############################################################################
# BEGIN fix (27 / 67) for 'jboss_karaf-secure_java_security_manager'
###############################################################################
(>&2 echo "Remediating rule 27/67: 'jboss_karaf-secure_java_security_manager'")
...
###############################################################################
# BEGIN fix (31 / 67) for 'jboss_karaf-secure_jmx_access'
###############################################################################
(>&2 echo "Remediating rule 31/67: 'jboss_karaf-secure_jmx_access'")
...
###############################################################################
# BEGIN fix (33 / 67) for 'jboss_karaf-enable_fips_authentication'
###############################################################################
(>&2 echo "Remediating rule 33/67: 'jboss_karaf-enable_fips_authentication'")
...
###############################################################################
# BEGIN fix (34 / 67) for 'jboss_karaf-stored_passwords_encrypted'
###############################################################################
(>&2 echo "Remediating rule 34/67: 'jboss_karaf-stored_passwords_encrypted'")
...
###############################################################################
# BEGIN fix (38 / 67) for 'jboss_karaf-dod_cns_certificates'
###############################################################################
(>&2 echo "Remediating rule 38/67: 'jboss_karaf-dod_cns_certificates'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-dod_cns_certificates' IS MISSING!")

# END fix for 'jboss_karaf-dod_cns_certificates'

###############################################################################
# BEGIN fix (39 / 67) for 'jboss_karaf-pki_assocation_permission'
###############################################################################
(>&2 echo "Remediating rule 39/67: 'jboss_karaf-pki_assocation_permission'")
...
###############################################################################
# BEGIN fix (40 / 67) for 'jboss_karaf-enable_secure_connections'
###############################################################################
(>&2 echo "Remediating rule 40/67: 'jboss_karaf-enable_secure_connections'")
...
###############################################################################
# BEGIN fix (41 / 67) for 'jboss_karaf-enable_ldap_ssl'
###############################################################################
(>&2 echo "Remediating rule 41/67: 'jboss_karaf-enable_ldap_ssl'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-enable_ldap_ssl' IS MISSING!")

# END fix for 'jboss_karaf-enable_ldap_ssl'

###############################################################################
# BEGIN fix (42 / 67) for 'jboss_karaf-remove_cleartext_passwords'
###############################################################################
(>&2 echo "Remediating rule 42/67: 'jboss_karaf-remove_cleartext_passwords'")
...
###############################################################################
# BEGIN fix (43 / 67) for 'jboss_karaf-vender_supported_version'
###############################################################################
(>&2 echo "Remediating rule 43/67: 'jboss_karaf-vender_supported_version'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-vender_supported_version' IS MISSING!")

# END fix for 'jboss_karaf-vender_supported_version'

###############################################################################
# BEGIN fix (44 / 67) for 'jboss_karaf-system_admin_access'
###############################################################################
(>&2 echo "Remediating rule 44/67: 'jboss_karaf-system_admin_access'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-system_admin_access' IS MISSING!")

# END fix for 'jboss_karaf-system_admin_access'

###############################################################################
# BEGIN fix (45 / 67) for 'jboss_karaf-disable_hot_deployment'
###############################################################################
(>&2 echo "Remediating rule 45/67: 'jboss_karaf-disable_hot_deployment'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-disable_hot_deployment' IS MISSING!")

# END fix for 'jboss_karaf-disable_hot_deployment'

###############################################################################
# BEGIN fix (46 / 67) for 'jboss_karaf-enable_ssl'
###############################################################################
(>&2 echo "Remediating rule 46/67: 'jboss_karaf-enable_ssl'")
...
###############################################################################
# BEGIN fix (48 / 67) for 'jboss_karaf-process_owner_console_access'
###############################################################################
(>&2 echo "Remediating rule 48/67: 'jboss_karaf-process_owner_console_access'")
...
###############################################################################
# BEGIN fix (49 / 67) for 'jboss_karaf-enable_encrypted_passwords'
###############################################################################
(>&2 echo "Remediating rule 49/67: 'jboss_karaf-enable_encrypted_passwords'")
...
###############################################################################
# BEGIN fix (51 / 67) for 'jboss_karaf-valid_dod_certificates'
###############################################################################
(>&2 echo "Remediating rule 51/67: 'jboss_karaf-valid_dod_certificates'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-valid_dod_certificates' IS MISSING!")

# END fix for 'jboss_karaf-valid_dod_certificates'

###############################################################################
# BEGIN fix (52 / 67) for 'jboss_karaf-enable_fips_modules'
###############################################################################
(>&2 echo "Remediating rule 52/67: 'jboss_karaf-enable_fips_modules'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-enable_fips_modules' IS MISSING!")

# END fix for 'jboss_karaf-enable_fips_modules'

###############################################################################
# BEGIN fix (53 / 67) for 'jboss_karaf-logging_access'
###############################################################################
(>&2 echo "Remediating rule 53/67: 'jboss_karaf-logging_access'")
...
###############################################################################
# BEGIN fix (55 / 67) for 'jboss_karaf-password_complexity_policy'
###############################################################################
(>&2 echo "Remediating rule 55/67: 'jboss_karaf-password_complexity_policy'")
...
###############################################################################
# BEGIN fix (56 / 67) for 'jboss_karaf-deployed_apps-java_perm_docs'
###############################################################################
(>&2 echo "Remediating rule 56/67: 'jboss_karaf-deployed_apps-java_perm_docs'")
...
###############################################################################
# BEGIN fix (59 / 67) for 'jboss_karaf-disaster_recovery'
###############################################################################
(>&2 echo "Remediating rule 59/67: 'jboss_karaf-disaster_recovery'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-disaster_recovery' IS MISSING!")

# END fix for 'jboss_karaf-disaster_recovery'

###############################################################################
# BEGIN fix (60 / 67) for 'jboss_karaf-password_expiration_policy'
###############################################################################
(>&2 echo "Remediating rule 60/67: 'jboss_karaf-password_expiration_policy'")
...
###############################################################################
# BEGIN fix (61 / 67) for 'jboss_karaf-physical_protections'
###############################################################################
(>&2 echo "Remediating rule 61/67: 'jboss_karaf-physical_protections'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-physical_protections' IS MISSING!")

# END fix for 'jboss_karaf-physical_protections'

###############################################################################
# BEGIN fix (62 / 67) for 'jboss_karaf-assign_administator'
###############################################################################
(>&2 echo "Remediating rule 62/67: 'jboss_karaf-assign_administator'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-assign_administator' IS MISSING!")

# END fix for 'jboss_karaf-assign_administator'

###############################################################################
# BEGIN fix (63 / 67) for 'jboss_karaf-auditing_policy'
###############################################################################
(>&2 echo "Remediating rule 63/67: 'jboss_karaf-auditing_policy'")
(>&2 echo "FIX FOR THIS RULE 'jboss_karaf-auditing_policy' IS MISSING!")

# END fix for 'jboss_karaf-auditing_policy'

###############################################################################
# BEGIN fix (64 / 67) for 'jboss_karaf-incident_response'
###############################################################################
(>&2 echo "Remediating rule 64/67: 'jboss_karaf-incident_response'")
...
###############################################################################
# BEGIN fix (66 / 67) for 'jboss_karaf-incident_response_exercises'
###############################################################################
(>&2 echo "Remediating rule 66/67: 'jboss_karaf-incident_response_exercises'")
...
###############################################################################
# BEGIN fix (67 / 67) for 'jboss_karaf-backup_schedule'
###############################################################################
(>&2 echo "Remediating rule 67/67: 'jboss_karaf-backup_schedule'")
