###############################################################################
#
# Bash Remediation Script for United States Government Configuration Baseline (USGCB)
#
# Profile Description:
...
# $ oscap xccdf generate fix --profile usgcb-rhel6-server --fix-type bash xccdf-file.xml
#
