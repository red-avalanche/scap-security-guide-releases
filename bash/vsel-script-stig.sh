...
###############################################################################
# BEGIN fix (1 / 39) for 'oas_action_app_secondary'
###############################################################################
(>&2 echo "Remediating rule 1/39: 'oas_action_app_secondary'")
...
###############################################################################
# BEGIN fix (2 / 39) for 'oas_action_default_primary'
###############################################################################
(>&2 echo "Remediating rule 2/39: 'oas_action_default_primary'")
...
###############################################################################
# BEGIN fix (3 / 39) for 'oas_action_app_primary'
###############################################################################
(>&2 echo "Remediating rule 3/39: 'oas_action_app_primary'")
...
###############################################################################
# BEGIN fix (4 / 39) for 'oas_heuristicAnalysis'
###############################################################################
(>&2 echo "Remediating rule 4/39: 'oas_heuristicAnalysis'")
...
###############################################################################
# BEGIN fix (5 / 39) for 'oas_macroAnalysis'
###############################################################################
(>&2 echo "Remediating rule 5/39: 'oas_macroAnalysis'")
...
###############################################################################
# BEGIN fix (6 / 39) for 'oas_exclusions'
###############################################################################
(>&2 echo "Remediating rule 6/39: 'oas_exclusions'")
(>&2 echo "FIX FOR THIS RULE 'oas_exclusions' IS MISSING!")

# END fix for 'oas_exclusions'

###############################################################################
# BEGIN fix (7 / 39) for 'oas_scanNWFiles'
###############################################################################
(>&2 echo "Remediating rule 7/39: 'oas_scanNWFiles'")
...
###############################################################################
# BEGIN fix (8 / 39) for 'oas_scanOnWrite'
###############################################################################
(>&2 echo "Remediating rule 8/39: 'oas_scanOnWrite'")
...
###############################################################################
# BEGIN fix (9 / 39) for 'oas_action_default_secondary'
###############################################################################
(>&2 echo "Remediating rule 9/39: 'oas_action_default_secondary'")
...
###############################################################################
# BEGIN fix (10 / 39) for 'oas_enabled'
###############################################################################
(>&2 echo "Remediating rule 10/39: 'oas_enabled'")
...
###############################################################################
# BEGIN fix (11 / 39) for 'oas_action_timeout'
###############################################################################
(>&2 echo "Remediating rule 11/39: 'oas_action_timeout'")
...
###############################################################################
# BEGIN fix (12 / 39) for 'oas_action_error'
###############################################################################
(>&2 echo "Remediating rule 12/39: 'oas_action_error'")
...
###############################################################################
# BEGIN fix (13 / 39) for 'oas_program'
###############################################################################
(>&2 echo "Remediating rule 13/39: 'oas_program'")
...
###############################################################################
# BEGIN fix (14 / 39) for 'oas_scanMaxTmo'
###############################################################################
(>&2 echo "Remediating rule 14/39: 'oas_scanMaxTmo'")
...
###############################################################################
# BEGIN fix (15 / 39) for 'oas_decompArchive'
###############################################################################
(>&2 echo "Remediating rule 15/39: 'oas_decompArchive'")
...
###############################################################################
# BEGIN fix (16 / 39) for 'oas_allFiles'
###############################################################################
(>&2 echo "Remediating rule 16/39: 'oas_allFiles'")
...
###############################################################################
# BEGIN fix (17 / 39) for 'oas_scanOnRead'
###############################################################################
(>&2 echo "Remediating rule 17/39: 'oas_scanOnRead'")
...
###############################################################################
# BEGIN fix (18 / 39) for 'restricted_user'
###############################################################################
(>&2 echo "Remediating rule 18/39: 'restricted_user'")
(>&2 echo "FIX FOR THIS RULE 'restricted_user' IS MISSING!")

# END fix for 'restricted_user'

###############################################################################
# BEGIN fix (19 / 39) for 'web_client_firewalled'
###############################################################################
(>&2 echo "Remediating rule 19/39: 'web_client_firewalled'")
(>&2 echo "FIX FOR THIS RULE 'web_client_firewalled' IS MISSING!")

# END fix for 'web_client_firewalled'

###############################################################################
# BEGIN fix (20 / 39) for 'virus_notification'
###############################################################################
(>&2 echo "Remediating rule 20/39: 'virus_notification'")
...
###############################################################################
# BEGIN fix (21 / 39) for 'updates_source'
###############################################################################
(>&2 echo "Remediating rule 21/39: 'updates_source'")
(>&2 echo "FIX FOR THIS RULE 'updates_source' IS MISSING!")

# END fix for 'updates_source'

###############################################################################
# BEGIN fix (22 / 39) for 'dats_updated'
###############################################################################
(>&2 echo "Remediating rule 22/39: 'dats_updated'")
(>&2 echo "FIX FOR THIS RULE 'dats_updated' IS MISSING!")

# END fix for 'dats_updated'

###############################################################################
# BEGIN fix (23 / 39) for 'scanned_media'
###############################################################################
(>&2 echo "Remediating rule 23/39: 'scanned_media'")
(>&2 echo "FIX FOR THIS RULE 'scanned_media' IS MISSING!")

# END fix for 'scanned_media'

###############################################################################
# BEGIN fix (24 / 39) for 'web_client_disabled'
###############################################################################
(>&2 echo "Remediating rule 24/39: 'web_client_disabled'")
...
###############################################################################
# BEGIN fix (25 / 39) for 'dats_auto_update'
###############################################################################
(>&2 echo "Remediating rule 25/39: 'dats_auto_update'")
(>&2 echo "FIX FOR THIS RULE 'dats_auto_update' IS MISSING!")

# END fix for 'dats_auto_update'

###############################################################################
# BEGIN fix (26 / 39) for 'ods_exclusions'
###############################################################################
(>&2 echo "Remediating rule 26/39: 'ods_exclusions'")
(>&2 echo "FIX FOR THIS RULE 'ods_exclusions' IS MISSING!")

# END fix for 'ods_exclusions'

###############################################################################
# BEGIN fix (27 / 39) for 'ods_program'
###############################################################################
(>&2 echo "Remediating rule 27/39: 'ods_program'")
...
###############################################################################
# BEGIN fix (28 / 39) for 'ods_decompArchive'
###############################################################################
(>&2 echo "Remediating rule 28/39: 'ods_decompArchive'")
...
###############################################################################
# BEGIN fix (29 / 39) for 'ods_action_app_secondary'
###############################################################################
(>&2 echo "Remediating rule 29/39: 'ods_action_app_secondary'")
...
###############################################################################
# BEGIN fix (30 / 39) for 'ods_macroAnalysis'
###############################################################################
(>&2 echo "Remediating rule 30/39: 'ods_macroAnalysis'")
...
###############################################################################
# BEGIN fix (31 / 39) for 'ods_extensions'
###############################################################################
(>&2 echo "Remediating rule 31/39: 'ods_extensions'")
...
###############################################################################
# BEGIN fix (32 / 39) for 'ods_action_default_primary'
###############################################################################
(>&2 echo "Remediating rule 32/39: 'ods_action_default_primary'")
...
###############################################################################
# BEGIN fix (33 / 39) for 'ods_scanNWFiles_local'
###############################################################################
(>&2 echo "Remediating rule 33/39: 'ods_scanNWFiles_local'")
...
###############################################################################
# BEGIN fix (34 / 39) for 'ods_heuristicAnalysis'
###############################################################################
(>&2 echo "Remediating rule 34/39: 'ods_heuristicAnalysis'")
...
###############################################################################
# BEGIN fix (35 / 39) for 'ods_enabled'
###############################################################################
(>&2 echo "Remediating rule 35/39: 'ods_enabled'")
(>&2 echo "FIX FOR THIS RULE 'ods_enabled' IS MISSING!")

# END fix for 'ods_enabled'

###############################################################################
# BEGIN fix (36 / 39) for 'ods_action_default_secondary'
###############################################################################
(>&2 echo "Remediating rule 36/39: 'ods_action_default_secondary'")
...
###############################################################################
# BEGIN fix (38 / 39) for 'ods_allFiles'
###############################################################################
(>&2 echo "Remediating rule 38/39: 'ods_allFiles'")
...
###############################################################################
# BEGIN fix (39 / 39) for 'ods_action_app_primary'
###############################################################################
(>&2 echo "Remediating rule 39/39: 'ods_action_app_primary'")
