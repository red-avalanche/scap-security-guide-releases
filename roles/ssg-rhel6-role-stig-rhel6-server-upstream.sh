###############################################################################
#
# Bash remediation role for profile stig-rhel6-server-upstream
# Profile Title:  Common Profile for General-Purpose SystemsDISA STIG for Red Hat Enterprise Linux 6
...
# 	$ oscap xccdf generate fix --profile stig-rhel6-server-upstream --template urn:xccdf:fix:script:sh sds.xml 
#
