###############################################################################
#
# Bash remediation role for profile stig-ol7-disa
...
# 	$ oscap xccdf generate fix --profile stig-ol7-disa --template urn:xccdf:fix:script:sh xccdf-file.xml 
#
...
###############################################################################
# BEGIN fix (127 / 135) for 'dconf_use_text_backend'
###############################################################################
(>&2 echo "Remediating rule 127/135: 'dconf_use_text_backend'")
